...
impl ConnectionPool {
    ...
    pub(super) async fn prepare_discover_peers_response(&self, n: &PeerID, p: DiscoverPeersPacket) -> DiscoverPeersRespPacket {
        ...
        // TODO [$623735a2d05ad70008ada725]: Create an offline_peers store to return better results
        ...
        'higher: for bucket_level in 0..128 {
            for bucket_id in 0..3 {
                ...
                if peers.is_empty() {
                    ...
                    // TODO [$623735a2d05ad70008ada726]: Try to fill lower buckets when appropriate
